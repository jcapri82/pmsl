class HomeController < ApplicationController 
  ...
  def index 
      if user_signed_in? 
        ...
        # load current user's root files (documents) (which aren't in a folder)
  ...
  def share
    ...
    email_addresses.each do |email_address|
      ...
      # getting the shared user id right the owner the email has already signed up with PMSL FileSharing
